...
?>
<table style="width:100%;text-align: center;border-collapse: collapse;" border="1" class="giohang">
  <tr>
    <th>Id</th>
    <th>Mã sp</th>
    <th>Tên sản phẩm</th>
   ...
   <tr>
    <td colspan="9">
      ...
      <?php
        if(isset($_SESSION['dangky'])){
          ?>
           <p><a href="pages/main/thanhtoan.php" style="text-decoration:none">Đặt hàng</a></p>
      <?php
        }else{
      ?>
